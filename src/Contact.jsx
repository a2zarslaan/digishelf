...
function Contact() {
	return (
		<div className='border bg-gray-700 bg-opacity-10  xl:grid xl:grid-cols-3 xl:grid-rows-3 w-full h-[80%] overflow-y-auto xl:overflow-hidden'>
			...
			<div className='xl:overflow-y-auto xl:text-lg xl:col-start-3 xl:row-span-3 xl:backdrop-blur-sm py-5 px-10'>
				<p>
					As certified graphics engineering experts, we have the knowledge and
					resources to handle projects of any size and complexity, even with
					tight deadlines. We understand that every project is unique, and we
					work closely with our clients to ensure that their vision is brought
				...
				<p>
					...
					<div>
						<span className='font-bold'>Project estimates: </span>If you do not
						have detailed terms of reference yet, we can provide a rough
						estimate of the project to give you an idea of the scope and cost.
					</div>
